            ...
            projectData.map((project, index) => (
              <article className='relative rounded-lg shadow-xl bg-white p-10'>
                ...
                <div className='text-gray-500 text-xs space-x-4'>
                  <span>
                    <strong>Finished on</strong>: {new Date(project.date).toLocaleDateString()}
                  </span>
                  <span>
                  ...
                  <p className='my-6 text-lg text-gray-700 leading-relaxed truncate'>{project.description}</p>
